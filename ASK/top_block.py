...
# Title: Top Block
# Generated: Thu Mar 30 14:39:43 2023
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Message = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, 1000, 1, 0)
        self.Carrier = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 10000, 4, 0)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.Carrier, 0), (self.blocks_multiply_xx_0, 1))    
        self.connect((self.Message, 0), (self.blocks_multiply_xx_0, 0))    
