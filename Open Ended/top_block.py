...
# Title: Top Block
# Generated: Wed Jun 28 11:14:28 2023
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.na = na = 1
        self.center_frequency = center_frequency = 100e6
        self.bw = bw = 10e6

        ##################################################
        # Blocks
        ##################################################
        self._na_range = Range(0, 10, 1, 1, 200)
        self._na_win = RangeWidget(self._na_range, self.set_na, "na", "counter_slider", float)
        self.top_layout.addWidget(self._na_win)
        self._center_frequency_range = Range(90e6, 105e6, 0.5e6, 100e6, 200)
        ...
        self.uhd_usrp_source_0.set_bandwidth(250e6, 0)
