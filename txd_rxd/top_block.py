...
# Title: Top Block
# Generated: Thu Jun  8 14:37:51 2023
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._f2_range = Range(10, 20000, 1, 50, 200)
        self._f2_win = RangeWidget(self._f2_range, self.set_f2, "f2", "counter_slider", float)
        self.top_grid_layout.addWidget(self._f2_win, 2,0,1,1)
        self._f1_range = Range(10, 20000, 1, 50, 200)
        self._f1_win = RangeWidget(self._f1_range, self.set_f1, "f1", "counter_slider", float)
        self.top_grid_layout.addWidget(self._f1_win, 1,0,1,1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_win, 4,0,1,1)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, f2, 1, 0)
    ...
    def set_f2(self, f2):
        self.f2 = f2
        self.analog_sig_source_x_1.set_frequency(self.f2)
